...
public class MainFrame extends JFrame implements ActionListener {
	...
	String[] alogorithmNames = { "FCFS", "SSTF", "SCAN", "CSCAN", "LOOK",
			"CLOOK" };
	String[] nameOfTheButtons = { "input", "Randoms", "Draw Graph" };
	...
	public void initComponents() {
		...
		buttonPanel_.setPreferredSize(new Dimension(100, 200));
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("input")) {
			...
			if (selected == 0) {
				//System.out.println(new DrawGraph(diskPosstion));
			//	drawgraphpanel x=new drawgraphpanel(new DrawGraph(diskPosstion));
				drawgraphpanel.hai(new DrawGraph(diskPosstion));
				//x.setGraphPanel(new DrawGraph(diskPosstion));
